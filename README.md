...
*   Perda de pacotes — A perda foi estudada no NS2 usando ErrorModel com diferentes taxas rate_, e os traces foram usados para calcular pacotes enviados, recebidos e perdidos. A análise mostra diferenças claras entre UDP e TCP: o UDP sofre diretamente as perdas (sem retransmissão), impactando imediatamente a aplicação em tempo real, o TCP, por sua vez, tenta recuperar por retransmissões, o que aumenta latência e reduz o throughput efetivo.
